...
var ConditionList = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view(vnode) {
    ...
    return m("div", {
      ...
      }, m("span", null, humanize.humanizeCondition(condition)), _this.progress(condition));
    }));
  };
...
/* harmony export */   OPERATOR: () => (/* reexport safe */ _common_types_data__WEBPACK_IMPORTED_MODULE_10__.OPERATOR),
...
/* harmony import */ var _common_types_data__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../common/types/data */ "./src/common/types/data.ts");
...
function getConditionMap(_x) {
  return _getConditionMap.apply(this, arguments);
}
function _getConditionMap() {
  _getConditionMap = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee(forceRefresh) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return getConditions(forceRefresh);
        case 3:
...
function getConditions(_x2) {
  return _getConditions.apply(this, arguments);
}
function _getConditions() {
  _getConditions = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2(forceRefresh) {
    var conditions;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 5;
          return flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default().store.find('collector-condition');
        case 5:
