    ...
    return m("table", {
      ...
      return m("tr", null, m("td", null, m((flarum_common_components_Select__WEBPACK_IMPORTED_MODULE_7___default()), {
        ...
        onchange: function (name) {
          ...
          _this3.attrs.conditions(_this3.conditions.filter(noNewItem));
          ;
        }.bind(_this3)
    ...
    return m("table", {
      ...
      return m("tr", null, m("td", null, m((flarum_common_components_Select__WEBPACK_IMPORTED_MODULE_8___default()), {
        ...
        onchange: function (name) {
          ...
          _this3.attrs.rewards(_this3.rewards.filter(noNewItem));
        }.bind(_this3)
      })), m("td", null, m("input", {
        className: "FormControl",
        type: "text",
...
/* harmony import */ var _common_utils_HumanizeUtils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../common/utils/HumanizeUtils */ "./src/common/utils/HumanizeUtils.tsx");
/* harmony import */ var flarum_common_components_Checkbox__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! flarum/common/components/Checkbox */ "flarum/common/components/Checkbox");
/* harmony import */ var flarum_common_components_Checkbox__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(flarum_common_components_Checkbox__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! flarum/common/components/LinkButton */ "flarum/common/components/LinkButton");
/* harmony import */ var flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_10__);
...
/* harmony import */ var _common_models_CustomCondition__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../common/models/CustomCondition */ "./src/common/models/CustomCondition.ts");
/* harmony import */ var _editCustomModal__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./editCustomModal */ "./src/admin/components/editCustomModal.tsx");
...
var adminPage = /*#__PURE__*/function (_ExtensionPage) {
  function adminPage() {
    ...
    _this.autoEmitObj = {};
    _this.invalidTags = void 0;
    _this.invalidTagsObj = {};
    _this.customs = void 0;
  ...
  _proto.content = function content(vnode) {
    ...
    return m("div", {
      ...
      className: "Table"
    }, m("thead", null, m("tr", null, m("th", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.emit_control.name')), m("th", null, m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_10___default()), {
      onclick: this.toggleAll("event")
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.emit_control.event'))), m("th", null, m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_10___default()), {
      onclick: this.toggleAll("update")
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.emit_control.update'))), m("th", null, m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_10___default()), {
      onclick: this.toggleAll("manual")
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.emit_control.manual'))), m("th", null, m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_10___default()), {
      onclick: this.toggleAll("abs")
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.emit_control.abs'))))), m("tbody", null, this.getControls()))), (0,_common_utils_NodeUtil__WEBPACK_IMPORTED_MODULE_6__.showIf)(this.loadingData, m((flarum_common_components_LoadingIndicator__WEBPACK_IMPORTED_MODULE_7___default()), null)), this.submitButton(), m("div", {
      className: "Form-group valid-tags"
    }, m("h3", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans("xypp-collector.admin.valid_tag")), m("div", {
      className: "xypp-collector-valid-tags-check"
    }, this.getValidTags())), this.buildSettingComponent({
      setting: "xypp.collector.max_keep",
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.max_keep'),
      type: "number",
      min: 1
    }), this.buildSettingComponent({
      setting: "xypp.collector.use_custom",
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.use_custom'),
      type: "boolean"
    }), this.buildSettingComponent({
      setting: "xypp.collector.custom-global-update",
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.custom_global_update'),
      type: "boolean"
    }), this.buildSettingComponent({
      setting: "xypp.collector.auto_update",
      label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.auto_update'),
      type: "boolean"
    }), this.submitButton(), m("div", null, m("h2", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans("xypp-collector.admin.custom.title")), m("table", null, m("thead", null, m("tr", null, m("th", null, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans("xypp-collector.admin.custom.name")), m("th", null))), m("tbody", null, (_this$customs = this.customs) == null ? void 0 : _this$customs.map(function (custom) {
      return m("tr", {
        className: "custom-row"
      }, m("td", null, custom.display_name()), m("td", null, m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_5___default()), {
        className: "Button Button--primary",
        onclick: _this2.customEdit(custom)
      }, m("i", {
        "class": "fas fa-edit"
      })), m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_5___default()), {
        className: "Button Button--primary",
        onclick: _this2.customDelete(custom)
      }, m("i", {
      ...
      "class": "fas fa-plus"
    }), flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans("xypp-collector.admin.custom.add"))))))));
  };
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            m.redraw();
            _context.next = 4;
            return _common_utils_HumanizeUtils__WEBPACK_IMPORTED_MODULE_8__["default"].getInstance((flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default())).loadDefinition();
          case 4:
            _context.next = 6;
            return flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().store.find(_common_models_CustomCondition__WEBPACK_IMPORTED_MODULE_12__["default"].type);
          case 6:
            this.customs = _context.sent;
  ...
  _proto.getControls = function getControls() {
    ...
    var conditions = _common_utils_HumanizeUtils__WEBPACK_IMPORTED_MODULE_8__["default"].getInstance((flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default())).getAllConditions(true).toObject();
    return Object.keys(conditions).map(function (key) {
      return m("tr", {
        className: "emit-control-row"
      }, m("td", {
        className: "emit-control-label"
      }, m((flarum_common_components_LinkButton__WEBPACK_IMPORTED_MODULE_10___default()), {
        onclick: _this3.toggleRow(key)
      }, conditions[key].content)), m("td", {
        className: "emit-control-event"
      }, m((flarum_common_components_Checkbox__WEBPACK_IMPORTED_MODULE_9___default()), {
        onchange: _this3.changeStateCbMaker("event", key),
        state: _this3.checked("event", key),
        disabled: !_this3.checkType("event", key)
      })), m("td", {
        className: "emit-control-update"
      }, m((flarum_common_components_Checkbox__WEBPACK_IMPORTED_MODULE_9___default()), {
        onchange: _this3.changeStateCbMaker("update", key),
        state: _this3.checked("update", key),
        disabled: !_this3.checkType("update", key)
      })), m("td", {
        className: "emit-control-manual"
      }, m((flarum_common_components_Checkbox__WEBPACK_IMPORTED_MODULE_9___default()), {
        onchange: _this3.changeStateCbMaker("manual", key),
        state: _this3.checked("manual", key),
        disabled: !_this3.checkType("manual", key)
      })), m("td", {
        className: "emit-control-abs"
      }, m((flarum_common_components_Checkbox__WEBPACK_IMPORTED_MODULE_9___default()), {
        onchange: _this3.changeStateCbMaker("abs", key),
        state: _this3.checked("abs", key)
      }), (0,_common_utils_NodeUtil__WEBPACK_IMPORTED_MODULE_6__.showIf)(_this3.checkType("abs", key), "", m("span", null, m((flarum_common_components_Tooltip__WEBPACK_IMPORTED_MODULE_11___default()), {
        text: flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans("xypp-collector.admin.limited_accumulation_support")
      }, m("i", {
  ...
  _proto.checkType = function checkType(type, name) {
    var def = _common_utils_HumanizeUtils__WEBPACK_IMPORTED_MODULE_8__["default"].getInstance((flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default())).getRawConditionDefinition(name);
  ...
  _proto.toggleRow = function toggleRow(name) {
    ...
    return function (e) {
      ...
      var types = ["event", "update", "manual"].filter(function (type) {
        return _this4.checkType(type, name);
      });
      var target = types.find(function (type) {
        return _this4.autoEmitObj[type] && _this4.autoEmitObj[type][name];
      }) === undefined;
      types.forEach(function (type) {
        if (target) _this4.autoEmitObj[type][name] = true;else if (_this4.autoEmitObj[type][name]) delete _this4.autoEmitObj[type][name];
      });
    }.bind(this);
  };
  _proto.toggleAll = function toggleAll(type) {
    ...
    return function (e) {
      e.preventDefault();
      var all = Object.keys(_common_utils_HumanizeUtils__WEBPACK_IMPORTED_MODULE_8__["default"].getInstance((flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default())).getAllConditions().toObject()).filter(function (key) {
        return _this5.checkType(type, key);
      });
      if (!_this5.autoEmitObj[type]) _this5.autoEmitObj[type] = {};
      var target = true;
      if (Object.keys(_this5.autoEmitObj[type]).length == 0) target = false;
      all.forEach(function (key) {
        if (target) _this5.autoEmitObj[type][key] = true;else if (_this5.autoEmitObj[type][key]) delete _this5.autoEmitObj[type][key];
      });
      _this5.autoEmit(JSON.stringify(_this5.autoEmit));
    }.bind(this);
  };
  _proto.changeStateCbMaker = function changeStateCbMaker(type, name) {
    var _this6 = this;
    return function (e) {
      if (!_this6.autoEmitObj[type]) _this6.autoEmitObj[type] = {};
      if (!e) _this6.autoEmitObj[type][name] = true;else if (_this6.autoEmitObj[type][name]) delete _this6.autoEmitObj[type][name];
      _this6.autoEmit(JSON.stringify(_this6.autoEmitObj));
    }.bind(this);
  };
  _proto.getValidTags = function getValidTags() {
    var _this7 = this;
    return flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().store.all("tags").map(function (tag) {
      return m((flarum_common_components_Checkbox__WEBPACK_IMPORTED_MODULE_9___default()), {
        onchange: _this7.changeValidTagsStateCbMaker(tag),
        state: !_this7.invalidTagsObj[tag.id() || 0]
      }, tag.name());
    });
  };
  _proto.changeValidTagsStateCbMaker = function changeValidTagsStateCbMaker(tag) {
    var _this8 = this;
    return function (e) {
      if (!e) _this8.invalidTagsObj[tag.id() || 0] = true;else if (_this8.invalidTagsObj[tag.id() || 0]) delete _this8.invalidTagsObj[tag.id() || 0];
      _this8.invalidTags(JSON.stringify(_this8.invalidTagsObj));
    }.bind(this);
  };
  _proto.customEdit = function customEdit(custom) {
    var _this9 = this;
    return function (e) {
      e.preventDefault();
      flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().modal.show(_editCustomModal__WEBPACK_IMPORTED_MODULE_13__["default"], {
        item: custom,
        update: function update(item) {
          var _this9$customs;
          _this9.customs = (_this9$customs = _this9.customs) == null ? void 0 : _this9$customs.map(function (c) {
  ...
  _proto.customAdd = function customAdd() {
    var _this10 = this;
    return function (e) {
      e.preventDefault();
      flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().modal.show(_editCustomModal__WEBPACK_IMPORTED_MODULE_13__["default"], {
        update: function update(item) {
          var _this10$customs;
          (_this10$customs = _this10.customs) == null || _this10$customs.push(item);
          m.redraw();
        }
      });
    };
  };
  _proto.customDelete = function customDelete(custom) {
    var _this11 = this;
    return function (e) {
      e.preventDefault();
      if (!confirm(flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans("xypp-collector.admin.custom.delete-confirm") + "")) return;
      _this11.deletingCustom[custom.id() + ""] = true;
      m.redraw();
      custom["delete"]().then(function () {
        var _this11$customs;
        _this11.customs = (_this11$customs = _this11.customs) == null ? void 0 : _this11$customs.filter(function (c) {
          return c.id() != custom.id();
        });
        delete _this11.deletingCustom[custom.id() + ""];
        m.redraw();
      });
    };
  };
...
/***/ "./src/admin/components/editCustomModal.tsx":
/*!**************************************************!*\
  !*** ./src/admin/components/editCustomModal.tsx ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ editCustomModal)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/asyncToGenerator */ "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js");
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/esm/inheritsLoose */ "./node_modules/@babel/runtime/helpers/esm/inheritsLoose.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
...
/* harmony import */ var flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _common_utils_NodeUtil__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../common/utils/NodeUtil */ "./src/common/utils/NodeUtil.ts");
/* harmony import */ var _common_models_CustomCondition__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../common/models/CustomCondition */ "./src/common/models/CustomCondition.ts");
/* harmony import */ var _common_utils_HumanizeUtils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../common/utils/HumanizeUtils */ "./src/common/utils/HumanizeUtils.tsx");
...
var editCustomModal = /*#__PURE__*/function (_Modal) {
  function editCustomModal() {
    var _this;
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
  ...
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__["default"])(editCustomModal, _Modal);
  var _proto = editCustomModal.prototype;
  _proto.oninit = function oninit(vnode) {
    _Modal.prototype.oninit.call(this, vnode);
    var humanize = _common_utils_HumanizeUtils__WEBPACK_IMPORTED_MODULE_8__["default"].getInstance((flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default()));
    if (this.attrs.item) {
  ...
  _proto.title = function title() {
    return flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.custom.title');
  };
  _proto.oncreate = function oncreate(vnode) {
  ...
  _proto.content = function content() {
    ...
    return m("div", {
      ...
      "for": "xypp-collector-custom-ipt-name"
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.custom.name')), m("input", {
      id: "xypp-collector-custom-ipt-name",
      required: true,
      className: "FormControl",
      type: "text",
      step: "any",
      ...
      "for": "xypp-collector-custom-ipt-display_name"
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.custom.display_name')), m("input", {
      id: "xypp-collector-custom-ipt-display_name",
      required: true,
      className: "FormControl",
      type: "text",
      step: "any",
      ...
      onchange: function (e) {
        _this2.display_name = e.target.value;
      }.bind(this)
    })), m("div", {
      className: "Form-group"
    }, m("label", {
      "for": "xypp-collector-custom-ipt-evaluation"
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.custom.evaluation')), m("textarea", {
      id: "xypp-collector-custom-ipt-evaluation",
      required: true,
      className: "FormControl",
      step: "any",
      value: this.evaluation,
      onchange: function (e) {
        _this2.evaluation = e.target.value;
      }.bind(this)
    }, this.evaluation)), m("div", {
      className: "Form-group"
    }, m((flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_5___default()), {
      "class": "Button Button--primary",
      type: "submit",
      loading: this.loading
    }, (0,_common_utils_NodeUtil__WEBPACK_IMPORTED_MODULE_6__.showIf)(!!this.attrs.item, flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.custom.button-edit'), flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-collector.admin.custom.button')))), m("pre", null, Object.keys(humanize.getAllConditions(true).toObject()).map(function (condition) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            this.loading = true;
            m.redraw();
            item = this.attrs.item || flarum_admin_app__WEBPACK_IMPORTED_MODULE_4___default().store.createRecord(_common_models_CustomCondition__WEBPACK_IMPORTED_MODULE_7__["default"].type);
            _context.prev = 4;
            _context.next = 7;
            return item.save({
              name: this.name,
...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('xypp/collector', function () {
  ...
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('xypp-collector').registerPage(_components_adminPage__WEBPACK_IMPORTED_MODULE_2__["default"]).registerPermission({
    icon: 'fas fa-eye',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('xypp-collector.admin.permissions.view-condition'),
